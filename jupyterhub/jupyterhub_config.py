...
# c.JupyterHub.bind_url = 'http://ec2-18-196-51-80.eu-central-1.compute.amazonaws.com:8000'
...
c.JupyterHub.config_file = '/data/jupyterhub/jupyterhub_config.py'
...
c.JupyterHub.logo_file = '/src/jupyterhub/logo.png'
...
#        'cp', '-r', '/data/workshop', '/home/USERNAME/workshop', '&&', 
#        'cp', '-r', '/data/data', '/home/USERNAME/data']
